...
| TC-29 | Reject — email missing dot in domain (BUG-06) | Logged in as Librarian. | 1. Click "Add Member". 2. Enter email with no dot after @. 3. Fill remaining fields. 4. Confirm. | Email: `test@email` | System REJECTS. Displays "Invalid email" error. No member created. If accepted → BUG-06. | REQ-07 | EP |
